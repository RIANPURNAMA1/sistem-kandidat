...
export const templateStyles: Record<Template, TemplateStyles> = {
  ...
  modern: {
    inputClass: 'h-11 rounded-lg bg-white border-slate-200 shadow-sm focus-visible:border-[#009CE1] focus-visible:ring-2 focus-visible:ring-[#009CE1]/20 transition-all text-sm px-4',
